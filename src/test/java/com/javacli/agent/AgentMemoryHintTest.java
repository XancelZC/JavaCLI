...
class AgentMemoryHintTest {
    ...
    void explicitChromeRememberRequestStoresSitePreferenceInLongTermMemory() {
        String oldMemoryDir = System.getProperty("javacli.memory.dir");
        System.setProperty("javacli.memory.dir", tempDir.toString());
        try {
            ...
            agent.run("打开 https://www.yuque.com/xancelzc/gykdzg 这个语雀文档");
            ...
            if (oldMemoryDir == null) {
                System.clearProperty("javacli.memory.dir");
            } else {
                System.setProperty("javacli.memory.dir", oldMemoryDir);
            }
        }
    }
