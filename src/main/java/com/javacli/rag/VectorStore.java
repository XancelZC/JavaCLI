...
public class VectorStore implements AutoCloseable {
    ...
    public VectorStore(String projectPath) throws SQLException {
        this.projectPath = projectPath == null ? "" : java.nio.file.Paths.get(projectPath).toAbsolutePath().normalize().toString();
        String dbDir = System.getProperty("javacli.rag.dir",
                System.getProperty("user.home") + "/.javacli/rag");
