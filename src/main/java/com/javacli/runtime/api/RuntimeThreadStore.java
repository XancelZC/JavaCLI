...
public class RuntimeThreadStore implements AutoCloseable {
    ...
    public static Path defaultDbPath() {
        String configured = System.getProperty("javacli.runtime.dir");
        if (configured == null || configured.isBlank()) {
            configured = System.getenv("JAVACLI_RUNTIME_DIR");
        }
        if (configured == null || configured.isBlank()) {
            configured = Path.of(System.getProperty("user.home"), ".javacli", "runtime").toString();
        }
