...
public final class LanternaWindow {
     ...
     */
    public LanternaWindow(JavaCliConfig config, LlmClient llmClient) throws IOException {
        ...
        this.mainWindow = new BasicWindow("JavaCLI v16.0.0");
    ...
    public JavaCliConfig getConfig() {
        return config;
    }
}
