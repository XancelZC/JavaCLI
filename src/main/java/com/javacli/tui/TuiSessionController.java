...
import com.javacli.tui.history.ConversationSnapshot;
import com.javacli.tui.pane.CenterPane;
import com.javacli.tui.pane.StatusPane;
...
public final class TuiSessionController implements AutoCloseable {
    ...
    private final JavaCliConfig config;
    ...
    public TuiSessionController(JavaCliConfig config,
                                LlmClient llmClient,
                                Agent reactAgent,
        ...
        this.executor = Executors.newSingleThreadExecutor(r -> {
            Thread thread = new Thread(r, "javacli-tui-agent-runner");
    ...
    private boolean handleCommand(String input) {
        ...
        if (lower.startsWith("/save ")) {
            ...
            if (fact.isEmpty()) {
                appendSystem("请提供要保存的内容，例如 /save 这个项目使用 Java 21");
            } else {
