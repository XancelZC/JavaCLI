...
public class AgentOrchestrator {
     ...
     */
    public void setSkillSystem(com.javacli.skill.SkillRegistry skillRegistry,
                               com.javacli.skill.SkillContextBuffer skillContextBuffer) {
    ...
    private void runBatchParallel(List<ExecutionStep> batch, List<ExecutionStep> steps,
        ...
        ExecutorService executor = Executors.newFixedThreadPool(parallelism, r -> {
            Thread t = new Thread(r, "javacli-multi-agent");
            t.setDaemon(true);
            return t;
        });
